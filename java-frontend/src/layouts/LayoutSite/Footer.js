                        ...
                        <div className="address-footer">
                          <ul>
                            <li className="contact-1"><b>Địa chỉ</b><br />
                              <br />
                              <b>-Sài Gòn:<br /></b> 43 Huỳnh Văn Bánh P.17 Q.Phú Nhuận<br />
                              1041 Luỹ Bán Bích P.Tân Thành Q.Tân Phú<br /></li>
                            <li className="contact-2"><b>Điện thoại:</b> 0336311117</li>
                            <li className="contact-4"><b>Email:</b> goldie.vn@gmail.com</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-md-3 col-sm-12 col-xs-12 widget-footer">
                    ...
                    <div className="content-footer block-collapse">
                      <ul className="footerNav-link">
                        <li className="item">
                          <a href="/pages/about-us" title="Giới thiệu Degrey">Giới thiệu Goldie</a>
                        </li>
                        <li className="item">
                          <a href="/pages/stores" title="Hệ thống cửa hàng">Hệ thống cửa hàng</a>
                        </li>
                        <li className="item">
                          <a href="/pages/huong-dan-dat-hang-1" title="Hướng dẫn đặt hàng">Hướng dẫn đặt hàng</a>
                        </li>
                        <li className="item">
                          <a href="/pages/chinh-sach-va-quy-dinh" title="Chính sách và quy định">Chính sách và quy định</a>
                        </li>
                        <li className="item">
                          <a href="/pages/chi-nh-sa-ch-ba-o-ma-t" title="Chính sách bảo mật">Chính sách bảo mật</a>
                        </li>
                        <li className="item">
                          <a href="/pages/lien-he" title="Thông tin sở hữu">Thông tin sở hữu</a>
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div className="content-footer block-collapse">
                      <div className="footerInfo-hline">
                        ...
                        <div className="box-content">
                          <span>0336311117</span> <u>goldie.vn@gmail.com</u>
                        </div>
                      </div>
